...
#' @param pois_marg a list of length equal to \code{k_pois} ordered 1st regular and 2nd zero-inflated; the i-th element is a vector of the cumulative
...
#' @param pois_support a list of length equal to \code{k_pois} ordered 1st regular and 2nd zero-inflated; the i-th element is a vector of containing the r
#'     ordered support values, with a minimum of 0 and maximum determined via \code{\link[SimCorrMix]{maxcount_support}}
#' @export
#' @keywords correlation continuous Poisson method2
...
#' @references Please see additional references in \code{\link[SimCorrMix]{intercorr_cont_pois}}.
#'
...
#'
intercorr_cont_pois2 <- function(method = c("Fleishman", "Polynomial"),
                                 constants = NULL, rho_cont_pois = NULL,
                                 pois_marg = list(), pois_support = list()) {
